...
public class CategoryController {
     ...
     * @return
     */
    @GetMapping("/getAbleCategory")
    public Result<PageResult> getAbleCategory(CategoryTypePageDTO categoryTypePageDTO){
        log.info("用户传过来的带条件的page分页参数：{}", categoryTypePageDTO);
        PageResult pageResult = categoryService.getAbleCategory(categoryTypePageDTO);
        return Result.success(pageResult);
    }
