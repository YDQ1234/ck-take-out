...
import fun.cyhgraph.utils.ValidatePriceUtil;
...
public class DishServiceImpl implements DishService {
    ...
    public void addDishWithFlavor(DishDTO dishDTO) {
        ...
        if (!"".equals(ValidatePriceUtil.validatePrice(price,2,null))){
            throw new BaseException(ValidatePriceUtil.validatePrice(price,2,null));
        }
    ...
    @Override
    public PageResult getAbleDish(DishPageDTO dishPageDTO) {
        PageHelper.startPage(dishPageDTO.getPage(), dishPageDTO.getPageSize());
        Page<Dish> dishList = dishMapper.getAbleDish(dishPageDTO);
        return new PageResult(dishList.getTotal(), dishList.getResult());
    }
